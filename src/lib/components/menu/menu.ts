...
export type MenuItemToggle = MenuItemBase & { type: "toggle"; checked?: boolean; onToggle?: (newValue: boolean) => any };

export type MenuItem = MenuItemAction | MenuItemSubmenu | MenuItemToggle | MenuSeparator;
