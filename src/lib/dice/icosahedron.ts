...
const d20_faces: Array<PolyhedronFace> = [
	...
	},
	{
		// face 2
		axis: rAxis,
		angle: Math.PI - innerAngle,
		preRotation: (Math.PI * 5) / 3
	},
	{
		// face 3
		axis: [rAxis, xAxis],
		angle: [-innerAngle, -innerAngle]
	},
	{
		// face 4

		axis: [lAxis, xAxis],
		angle: [innerAngle, Math.PI - innerAngle]
	},
	{
		// face 5
		axis: [xAxis, rAxis],
		angle: [innerAngle, innerAngle],
		preRotation: (Math.PI * 2) / 3
	},
	{
		// face 6
		axis: [lAxis, rAxis],
		angle: [innerAngle, Math.PI + innerAngle],
		preRotation: (Math.PI * 8) / 3
	},
	{
		// face 7
		axis: lAxis,
		angle: innerAngle,
		preRotation: Math.PI / 3
	},
	{
		// face 8
		axis: xAxis,
...
export const IcosahedronD20 = polyhedron(
	'icosahedron_d20',
	'D20 Icosahedron',
	d20_faces,
	d20_shape,
