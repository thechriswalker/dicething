...
const diameterEdgeLengthRatio = 3 / (Math.sqrt(6) * 2); // ratio of diameter to edge length for a rhombic dodecahedron

const sqrt_3 = Math.sqrt(3);

const yAxis = new Vector3(0, 1, 0);

// we need axes for the left and right edges, and the innerangle for rotation.
const innerAngle = Math.PI / 3;
