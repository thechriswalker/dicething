...
const diceTags: Record<keyof typeof dice, DieTags> = {
	d2_coin: { kind: 'coin', sides: '2' },
	d4_caltrop: { kind: 'caltrop', variant: 'kite', sides: '4' },
	d4_caltrop_base: { kind: 'caltrop', variant: 'base', sides: '4' },
	d4_caltrop_custom: { kind: 'caltrop', variant: 'custom', sides: '4' },
	d4_truncated_tetrahedron: { kind: 'caltrop', variant: 'truncated', sides: '4' },
	d6_cube: { kind: 'polyhedron', variant: 'cube', sides: '6' },
	d4_crystal: { kind: 'crystal', sides: '4' },
	d6_crystal: { kind: 'crystal', sides: '6' },
	d8_crystal: { kind: 'crystal', sides: '8' },
	d10_crystal: { kind: 'crystal', sides: '10' },
	d00_crystal: { kind: 'crystal', sides: '00' },
	d12_crystal: { kind: 'crystal', sides: '12' },
	d12_dodecahedron: { kind: 'polyhedron', variant: 'dodecahedron', sides: '12' },
	d20_icosahedron: { kind: 'polyhedron', variant: 'icosahedron', sides: '20' },
	d12_rhombic: { kind: 'polyhedron', variant: 'rhombic', sides: '12' },
	d6_rhombic: { kind: 'trapezohedron', variant: 'rhombic', sides: '6' },
	d8_trapezohedron: { kind: 'trapezohedron', sides: '8' },
	d10_trapezohedron: { kind: 'trapezohedron', sides: '10' },
	...
	d6_skew: { kind: 'skew', sides: '6' },
	d8_truncated_octahedron: { kind: 'polyhedron', variant: 'truncated', sides: '8' },
	d12_tetartoid: { kind: 'skew', sides: '12' },
	d24_deltoidal_icositetrahedron: { kind: 'polyhedron', variant: 'deltoidal', sides: '24' },
